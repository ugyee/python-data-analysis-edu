...
import { BookOpen, User, LogIn, Code, FileQuestion, Menu, X, ArrowLeft, Sparkles } from 'lucide-react';
...
export function Navbar() {
  ...
  const navLinks = [
    { to: '/practice', label: '练习', icon: Code },
    { to: '/quiz', label: '测评', icon: FileQuestion },
  ];
